...
Overwrites the function prologue in memory so that:
The function returns immediately
No ETW events are emitted from that process
Applies architecture-specific patches for:
64-bit processes
32-bit processes
...
Detect attempts to disable telemetry
Build stronger detection logic around ETW integrity
...
Obfuscation
Evasion chaining
Modern EDR solutions are capable of detecting:
Unauthorized WriteProcessMemory calls
Tampering with ntdll.dll
...
Blue-team research environments
Running this against systems without authorization may violate organizational policies or applicable laws.
Ethical Notice
This project is published for educational, research, and defensive security learning purposes only.

##Defensive Takeaway
If you are a defender, this project highlights why it is important to:
Monitor memory modification of system DLLs
Detect ETW patching behavior
Treat ETW suppression as a high-confidence malicious signal
